...
- [ts-vimdoc.nvim](https://github.com/ibhagwan/ts-vimdoc.nvim):
  auto-generate vimdoc from markdown using treesitter for your neovim plugin.
  ![stars](https://img.shields.io/github/stars/ibhagwan/ts-vimdoc.nvim?style=social)
...
- [lemontify](https://github.com/ibhagwan/lemontify):
  OSX-inspired notifications script based on
  [my fork of lemonbar](https://github.com/ibhagwan/bar).
  ![stars](https://img.shields.io/github/stars/ibhagwan/lemontify?style=social)
